...
4. (If not using the entire light-shell dotfiles) configure nvim and zsh to set hook for the tmux-window-name plugin.
This is already configured if you are using this repository as-is.
...
> [!NOTE]
> This only works if you installed the `./scripts/` dir in `~/.config/light-shell/tmux/scripts/...`
