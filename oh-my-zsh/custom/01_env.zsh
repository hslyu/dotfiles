...
# provide simple previews if the tooling is available
...
bindkey "^[OR" tmux_previous_window  # F3
bindkey "^[[15~" tmux_next_window  # F5
bindkey "^[[17~" tmux_next_window  # F6
# bindkey "^[OR" dirhistory_zle_dirhistory_back  # F3, knob counter-clockwise
# bindkey "^[OQ" dirhistory_zle_dirhistory_back  # F2, knob counter-clockwise
